...
public class OperateService {
    ...
    private CamundaOperateClient getCamundaTaskListClient() throws OperateException {
        if (client == null) {
            ...
            client = new CamundaOperateClient.Builder().operateUrl("https://" + region + ".operate.camunda.io/" + clusterId)
    ...
    public List<ProcessDefinition> getProcessDefinitions() throws OperateException {
        ...
        SearchQuery procDefQuery = new SearchQuery.Builder().withFilter(processDefinitionFilter).withSize(1000).withSort(new Sort("version", SortOrder.DESC)).build();
